...
namespace ee.iLawyer.App.Wpf.ViewModels
{
    ...
    public class ClientViewModel : AbstractDataManipulationViewModel
    {
        ...
        public override void Query()
        {
            System.Threading.ThreadPool.QueueUserWorkItem(delegate
            {
                ...
                System.Threading.SynchronizationContext.Current.Post(pl =>
                {
                    try
                    {
                        var response = serviceProvider.QueryClient(new QueryClientRequest());
        ...
        public override BaseResponse Create()
        {
            ...
            try
            {
                var response = serviceProvider.CreateClient(new CreateClientRequest()
                {
        ...
        public override BaseResponse Update()
        {
            ...
            try
            {
                var response = serviceProvider.UpdateClient(new UpdateClientRequest()
                {
                    Id = SelectedItem.Id,
                    IsNP = SelectedItem.IsNP,
                    Name = SelectedItem.Name,
        ...
        public override BaseResponse Delete()
        {
            ...
            try
            {
                var response = serviceProvider.RemoveClient(new RemoveClientRequest()
                {

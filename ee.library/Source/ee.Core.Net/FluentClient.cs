using ee.Core.Net.Client;
using ee.Core.Net.Extensibility;
using ee.Core.Net.Internal;
...
namespace ee.Core.Net
{
    ...
    public class FluentClient : IClient
    {
        ...
        protected readonly bool MustDisposeBaseClient;
        ...
        protected readonly FluentClientOptions Options = new FluentClientOptions();
        ...
        /// <summary>Add a default behavior for all subsequent HTTP requests.</summary>
        /// <param name="apply">The default behavior to apply.</param>
        public IClient AddDefault(Func<IRequest, IRequest> apply)
        {
            this.Defaults.Add(apply);
            return this;
        }
        public IClient ApplyFilter(IHttpFilter filter)
        {
        ...
        private void SetDefaultUserAgent()
        {
            ...
            this.SetUserAgent($"FluentHttpClient/{version}");
        }

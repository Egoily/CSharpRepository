...
namespace ee.iLawyer.App.Wpf.ViewModels
{
    ...
    [BizModule(1,"Root", "法院管理", "module.court", "", typeof(ManageCourt))]
    [Ioc(null, false, true)]
    public class CourtViewModel : AbstractDataManipulationViewModel
    {
        ...
        public override void Query()
        {
            System.Threading.ThreadPool.QueueUserWorkItem(delegate
            {
                ...
                System.Threading.SynchronizationContext.Current.Post(pl =>
                {
                    try
                    {
                        var response = serviceProvider.QueryCourt(new QueryCourtRequest());
        ...
        public override BaseResponse Create()
        {
            ...
            try
            {
                var response = serviceProvider.CreateCourt(new CreateCourtRequest()
                {
        ...
        public override BaseResponse Update()
        {
            ...
            try
            {
                var response = serviceProvider.UpdateCourt(new UpdateCourtRequest()
                {
                    Id = SelectedItem.Id,
                    Rank = SelectedItem.Rank.ToString(),
                    Name = SelectedItem.Name,
        ...
        public override BaseResponse Delete()
        {
            ...
            try
            {
                var response = serviceProvider.RemoveCourt(new RemoveCourtRequest()
                {

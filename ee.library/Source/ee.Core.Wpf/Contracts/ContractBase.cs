...
namespace ee.Core.Wpf.Contracts
{
    /// <summary>
    ...
    {
        public const string FailedToUnloadAppDomain = "Failed to Unload AppDomain";
        public const string LifetimeTokenNotFound = "Lifetime Token not Found";
        public const string TokenCountZero = "Token Count Zero";
    }
}
